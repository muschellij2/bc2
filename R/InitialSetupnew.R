...
#'
#' @examples
InitialSetupnew <- function(y.pheno.complete,
                         baselineonly,
                         additive,
    ...
    covar.names <- GenerateCovarNamenew(baselineonly,
                                         additive,
                                         pairwise.interaction,
                                         saturated,
                                        x.self.design=x.self.design,
                                        x.self.design2=x.self.design2)
    z.all <- ZSelfDesigntoZallnew(x.self.design,
                                  x.self.design2,
                               baselineonly,
                               additive,
                               pairwise.interaction,
...
#'
#' @examples
SummaryResultnew <- function(model.result,
                          baselineonly,
                          additive,
                          pairwise.interaction,
                          saturated,
    ...
    }else if(is.null(colnames(z.design2))){
      full.second.stage.names <- paste0("self_design_group2",c(1:ncol(z.design)))
    }
  else{
    ...
    return(list(delta=delta,covariance.delta=covariance.delta,second.stage.mat = second.stage.mat,second.stage.test,global.test,loglikelihood = loglikelihood,
